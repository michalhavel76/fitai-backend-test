...
const scientific_correction_js_1 = __importDefault(require("./scientific-correction.js"));
const scientific_calibration_js_1 = require("./scientific-calibration.js");
...
const scientificRun = async (req, res) => {
    ...
    try {
        ...
        const correctionResult = await new Promise((resolve, reject) => {
            ...
            (0, scientific_correction_js_1.default)({}, mockRes);
        });
        ...
        const calibrationResult = await new Promise((resolve, reject) => {
            ...
            (0, scientific_calibration_js_1.scientificCalibrate)({}, mockRes);
        });
        // ✅ Step 3 – Calculate improvement
        const improvement = (Number(calibrationResult.averageAccuracy || 0) -
            Number(req.body.prevAccuracy || 0)) *
            100;
        // ✅ Step 4 – Save batch summary
        await client.query(`INSERT INTO food_audit_log (action, details, created_at)
       VALUES ($1, $2, NOW())`, [
            "scientific_batch",
            JSON.stringify({
                batchId,
